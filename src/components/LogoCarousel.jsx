...
const MaskedIcon = ({ src, size = "w-16 h-16" }) => (
    <div
...
const logos = [
    ...
    {
        name: "n8n",
        icon: <MaskedIcon src={n8nLogo} size="w-16 h-16" />
    },
    {
        name: "Make",
        icon: <MaskedIcon src={makeLogo} size="w-16 h-16" />
    },
    {
        name: "Zapier",
            ...
            <div className="relative flex overflow-x-hidden group">
                <div className="flex animate-marquee whitespace-nowrap">
                    {[...logos, ...logos, ...logos].map((logo, index) => (
                        ...
                        >
                            <div className="text-white group-hover/item:text-accent transition-colors duration-300 h-16 flex items-center justify-center">
                                {logo.icon}
                            </div>
